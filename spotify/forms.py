...
class GeneratePlaylistForm(FlaskForm):
    ...
    playlist_link1 = StringField('Personal Playlist Link (Optional)', render_kw={"placeholder": "Enter playlist link you think might represent you best. If you want songs from all your playlists to be considered in evaluating your music taste, leave this blank"})

    playlist_link2 = StringField("Friend's Playlist Link", validators=[DataRequired()], render_kw={"placeholder":"Link a playlist that best represents your buddy(can input playlist links from their account)"})
